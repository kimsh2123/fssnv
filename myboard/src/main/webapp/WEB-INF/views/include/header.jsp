...
<html>
  <head>
    ...
    <!-- Ionicons -->
    <link href="/resources/ionicons-master/css/ionicons.min.css" rel="stylesheet" type="text/css" />
    <!-- Theme style -->
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="" class="logo">
          ...
          <span class="logo-lg"><b>게시판</b> PROJECT</span>
        </a>
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="/resources/dist/img/sung_ha.jpg" class="user-image" alt="User Image"/>
                  <span class="hidden-xs">Sung Ha</span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <img src="/resources/dist/img/sung_ha.jpg" class="img-circle" alt="User Image" />
                    <p>
                      Sung Ha - Web Developer
                    </p>
                  </li>
                  <!-- Menu Body -->
                  <li class="user-body">
